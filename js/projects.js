...
const buildType_fields     = 'fields=build(id,buildTypeId,number,branchName,status,webUrl,finishOnAgentDate,statusText,failedToStart,problemOccurrences,testOccurrences(count,muted,passed,newFailed,testOccurrence(status,newFailure,muted,test(investigations(investigation(assignee))))))'
