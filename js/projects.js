...
const tests_fields           = 'fields=webUrl,count,passed,failed,muted,ignored,newFailed,testOccurrence(id,name,status,details,newFailure,muted,test(id,name,parsedTestName,href,investigations(investigation(assignee))))'
